...
int kbhit(void);           //检测键盘是否有键入
int getch(void);             //输入不需要回车键便返回
                    ...
                    for(int x = -1; x <= 1; x++)
                    {
                        ...
                        if(!(y == 0 && x == 0))          //原坐标不算
                        {
                            ...
                            else if(black_num == 3)
                            {
                                if(empty_num == 0)        //死四
                                    value[i][j] += 115;
                                else if (empty_num == 1)    //活四
                                    value[i][j] += 220;
                            }
                            else if(black_num >= 4)   //活五
                                value[i][j] += 10100;
                        }
                    }
                }
